...
namespace CArticulo
{
	public partial class Window
	{
		...
		protected virtual void Build()
		{
			...
			// Widget CArticulo.Window
			this.Name = "CArticulo.Window";
			this.Title = global::Mono.Unix.Catalog.GetString("Window");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Container child CArticulo.Window.Gtk.Container+ContainerChild
			...
			this.vbox2.Add(this.buttonSave);
			global::Gtk.Box.BoxChild w8 = ((global::Gtk.Box.BoxChild)(this.vbox2[this.buttonSave]));
			w8.Position = 1;
			w8.Expand = false;
			w8.Fill = false;
			this.Add(this.vbox2);
